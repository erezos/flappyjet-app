...
CREATE TABLE IF NOT EXISTS tournaments (
    ...
    prize_pool INTEGER NOT NULL DEFAULT 0, -- Total prize pool in gems
    prize_distribution JSONB NOT NULL DEFAULT '{"1": 0.5, "2": 0.3, "3": 0.2}', -- Percentage distribution
    max_participants INTEGER DEFAULT NULL, -- NULL = unlimited
    entry_fee INTEGER DEFAULT 0, -- Entry fee in gems
...
CREATE OR REPLACE FUNCTION create_weekly_tournament(
    ...
    p_prize_pool INTEGER DEFAULT 1000,
...
BEGIN
    ...
    INSERT INTO tournaments (
        ...
        tournament_name,
        'Weekly competition for FlappyJet Pro players. Compete for gems and exclusive rewards!',
        'weekly',
        start_time,
        end_time,
        'upcoming',
        p_prize_pool,
        '{"1": 0.5, "2": 0.3, "3": 0.2}'::JSONB
