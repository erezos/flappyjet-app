...
Tournament _$TournamentFromJson(Map<String, dynamic> json) => Tournament(
  ...
  tournamentType: $enumDecode(_$TournamentTypeEnumMap, json['tournament_type']),
  ...
  participantCount: Tournament._parseParticipantCount(
...
Map<String, dynamic> _$TournamentToJson(Tournament instance) =>
    <String, dynamic>{
      ...
      'prize_distribution': instance.prizeDistribution.map(
