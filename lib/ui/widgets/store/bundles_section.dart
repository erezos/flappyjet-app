/// 🎁 BUNDLES SECTION
/// 
/// Displays Bundle products (Heart Booster + No Ads)
...
class BundlesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final products = EconomyConfig.bundleProducts.values.toList();
            ...
            builder: (context, constraints) {
              ...
              return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildBundleCard(context, screenSize, product);
                },
              );
            },
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: (product.isBestValue ? const Color(0xFFFF6B35) : const Color(0xFF9C27B0))
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Icons - Responsive and constrained
                      FittedBox(
                        fit: BoxFit.scaleDown,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          ...
                          children: [
                            Image.asset(
                              ...
                              width: ResponsiveConfig.responsiveSize(44.0, screenSize, minScale: 0.8, maxScale: 1.2).clamp(36.0, 56.0),
                              height: ResponsiveConfig.responsiveSize(44.0, screenSize, minScale: 0.8, maxScale: 1.2).clamp(36.0, 56.0),
                              errorBuilder: (_, __, ___) => Icon(
                                Icons.favorite,
                                color: Colors.white,
                                size: ResponsiveConfig.responsiveSize(44.0, screenSize, minScale: 0.8, maxScale: 1.2).clamp(36.0, 56.0),
                              ),
                            ),
