...
class ProfileResponsiveConfig {
  ...
  double get headerBottomSpacing =>
      screenSize.height *
      0.005; // Minimal spacing to keep nickname banner close to PROFILE

  /// Spacing after nickname banner
  double get nicknameBottomSpacing =>
      screenSize.height * (isMobile ? 0.04 : 0.06);
  ...
  double get profileHeaderHeight =>
      screenSize.height * (isMobile ? 0.16 : 0.14);
  ...
  /// Jet preview width percentage - BIGGER: Main object of profile page
  double get jetPreviewWidthRatio => isMobile ? 0.85 : 0.75;

  /// Jet preview height percentage - BIGGER: Main object of profile page
  double get jetPreviewHeightRatio => isMobile ? 0.3 : 0.35;
...
extension ProfileResponsiveExtension on BuildContext {
  ProfileResponsiveConfig get profileConfig =>
      ProfileResponsiveConfig.fromContext(this);
}
