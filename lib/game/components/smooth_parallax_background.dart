...
/// Advanced parallax background with smooth transitions
/// Uses multiple ParallaxComponent instances for seamless transitions
class SmoothParallaxBackground extends Component with HasGameReference {
  int _lastScore = -1;
  ...
  Future<void> onLoad() async {
    ...
    debugPrint('🎨 🌊 SmoothParallaxBackground initialized');
  }
  ...
  Future<void> _loadInitialBackground(int score) async {
    ...
    try {
      ...
      debugPrint('🎨 🌊 Initial parallax loaded: $assetPath');
      
    } catch (e) {
      debugPrint('🎨 ⚠️ Failed to load initial parallax: $e');
  ...
  Future<void> _smoothTransitionToNewBackground(int score) async {
    ...
    try {
      debugPrint('🎨 🌊 Starting smooth parallax transition for score: $score');
      ...
      debugPrint('🎨 🌊 Smooth parallax transition in progress: $newAssetPath');
      
    } catch (e) {
      debugPrint('🎨 ⚠️ Smooth parallax transition failed: $e');
  ...
  Future<ParallaxComponent> _createMainParallax(String assetPath) async {
    try {
      ...
      debugPrint('🎨 ⚠️ Error creating parallax component: $e');
  ...
  Future<List<ParallaxLayer>> _createMainParallaxLayers(String mainAssetPath) async {
    ...
    try {
      ...
      debugPrint('🎨 ⚠️ Error creating parallax layers: $e');
  ...
  Future<void> _instantTransition(int score) async {
    try {
      ...
      debugPrint('🎨 🌊 Instant parallax transition: $newAssetPath');
      
    } catch (e) {
      debugPrint('🎨 ⚠️ Instant transition failed: $e');
      _createFallbackBackground();
    }
  }
  ...
  void _createFallbackBackground() {
    ...
    debugPrint('🎨 🌊 Using fallback background');
  }
