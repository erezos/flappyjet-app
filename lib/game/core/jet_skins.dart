...
class JetSkinCatalog {
  ...
  static final List<JetSkin> _allPremiumSkins = [
    ...
    // 🚁 Chopper lineup (filenames drive names)
    JetSkin(
      id: 'night_falcon',
      displayName: 'Night Falcon',
      description: 'Stealth-night patrol chopper built for precision.',
      assetPath: 'jets/Night_falcon.png',
      price: 0.0,
      rarity: JetRarity.rare,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'falcon', 'night'],
      thrustTint: Color(0xFF42A5F5),
    ),

    JetSkin(
      id: 'crimson_viper',
      displayName: 'Crimson Viper',
      description: 'Aggressive strike craft with crimson livery.',
      assetPath: 'jets/Crimson_viper.png',
      price: 0.0,
      rarity: JetRarity.rare,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'crimson', 'viper'],
      thrustTint: Color(0xFFFF5252),
    ),

    JetSkin(
      id: 'iron_fang',
      displayName: 'Iron Fang',
      description: 'Armored gunship with a bite of steel.',
      assetPath: 'jets/Iron Fang.png',
      price: 0.0,
      rarity: JetRarity.rare,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'iron', 'fang'],
      thrustTint: Color(0xFF66BB6A),
    ),

    JetSkin(
      id: 'commander_buzz',
      displayName: 'Commander Buzz',
      description: 'Command-grade chopper with precision comms.',
      assetPath: 'jets/Commander_buzz.png',
      price: 0.0,
      rarity: JetRarity.epic,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'commander', 'buzz'],
      thrustTint: Color(0xFF4CAF50),
    ),

    JetSkin(
      id: 'eagle_force_one',
      displayName: 'Eagle Force One',
      description: 'VIP escort chopper with eagle-eye recon.',
      assetPath: 'jets/Eagle_force_one.png',
      price: 0.0,
      rarity: JetRarity.epic,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'eagle', 'force'],
      thrustTint: Color(0xFF388E3C),
    ),

    JetSkin(
      id: 'firehawk',
      displayName: 'Firehawk',
      description: 'Blazing-fast attack chopper built for offense.',
      assetPath: 'jets/Firehawk.png',
      price: 0.0,
      rarity: JetRarity.epic,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.military,
      tags: ['chopper', 'fire', 'hawk'],
      thrustTint: Color(0xFFFF7043),
    ),

    JetSkin(
      id: 'starwhirl',
      displayName: 'Starwhirl',
      description: 'Showtime chopper with neon star flair.',
      assetPath: 'jets/Starwhirl.png',
      price: 0.0,
      rarity: JetRarity.epic,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.premium,
      tags: ['chopper', 'star', 'whirl'],
      thrustTint: Color(0xFF9C27B0),
    ),


    // 🟣 EPIC STUNT EXCLUSIVE (reward only)
    JetSkin(
      id: 'stunt_master',
      displayName: 'Stunt Master',
      description: 'Built for daring aerial tricks and razor-sharp turns.',
      assetPath: 'jets/stunt_master.png',
      price: 0.0,
      rarity: JetRarity.epic,
      isPurchased: false,
      isEquipped: false,
      category: JetSkinCategory.futuristic,
      tags: ['stunt', 'tournament', 'blue'],
      thrustTint: Color(0xFF4DDCFF),
    ),
